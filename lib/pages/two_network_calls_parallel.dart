...
class TwoNetworkCallsParallel extends StatefulWidget {
  @override
  _TwoNetworkCallsParallelState createState() =>
      _TwoNetworkCallsParallelState();
}

class _TwoNetworkCallsParallelState extends State<TwoNetworkCallsParallel> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Two Network Calls- Parallel"),
      ),
